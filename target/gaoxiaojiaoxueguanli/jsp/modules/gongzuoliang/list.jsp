            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">工作量管理</li>
                        <li class="breadcrumb-item active">工作量列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">工作量列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                 
                                            <label>
                                                工作量
                                                <input type="text" id="gongzhuoStartSearch" style="width: 100px;" onchange="gongzhuoChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                            </label>
                                                -
                                            <label>
                                                <input type="text" id="gongzhuoEndSearch" style="width: 100px;" onchange="gongzhuoChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                            </label>
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="教师名称" aria-controls="tableId">
                                            </label>
                                <button onclick="search()" type="button" class="btn btn-primary">查询</button>
                                <button onclick="add()" type="button" class="btn btn-success 新增">添加</button>
                                <button onclick="graph1('yonghu_id','gongzhuo','gongzuoliang','yonghu')" type="button" class="btn btn-success 报表">报表</button>
...
<script>
    ...
    function search() {
        ...
        if(sexTypesSelectSearchInput != null){
            ...
            //工作量
        var gongzhuoStartSearchInput = $('#gongzhuoStartSearch');
        if(gongzhuoStartSearchInput != null){
            var gongzhuoStartSearchValue = gongzhuoStartSearchInput.val();
            if( gongzhuoStartSearchValue  != 0){
                searchForm.gongzhuoStart = gongzhuoStartSearchValue;
            }
        }
        var gongzhuoEndSearchInput = $('#gongzhuoEndSearch');
        if(gongzhuoEndSearchInput != null){
            var gongzhuoEndSearchValue = gongzhuoEndSearchInput.val();
            if( gongzhuoEndSearchValue  != 0){
                searchForm.gongzhuoEnd = gongzhuoEndSearchValue;
            }
        }
                getDataList();
    }
    ...
    function getDataList() {
        http("gongzuoliang/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            gongzhuoStart: searchForm.gongzhuoStart,
            gongzhuoEnd: searchForm.gongzhuoEnd,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        //工作量
        var gongzhuoCell = document.createElement('td');
        gongzhuoCell.innerHTML = item.gongzhuo;
        row.appendChild(gongzhuoCell);


        //发布时间
        var jiluTimeCell = document.createElement('td');
        jiluTimeCell.innerHTML = item.jiluTime;
        row.appendChild(jiluTimeCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("gongzuoliang/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addgongzuoliang", "addgongzuoliang");
        window.location.href = "add-or-update.jsp"
    }

    //报表
    function graph1(name,total,table,table1) {
        //要跳转的页面
